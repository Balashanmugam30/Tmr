...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#050505] text-[#F5F4EF] font-manrope selection:bg-[#FF4B00] selection:text-white">
      ...
      {/* SECTION 04 — COMPACT CONTAINED EDITORIAL VIDEO METHODOLOGY SECTION */}
      <section className="bg-[#050505] text-white relative w-full overflow-hidden py-16 sm:py-20 border-b border-white/10" id="approach">
        <div className="max-w-[1360px] mx-auto px-6 md:px-16">
          
          {/* Contained Editorial Video Frame */}
          <div className="relative w-full aspect-[21/9] sm:aspect-[2.4/1] max-h-[580px] rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-black group">
            ...
            <video
              ...
              className="absolute inset-0 w-full h-full object-cover object-center pointer-events-none z-0 scale-100 group-hover:scale-[1.02] transition-transform duration-1000 ease-out"
            ...
            {/* Readability Vignette Gradient Overlays */}
            ...
            {/* Contained Overlay Content Stack */}
            <div className="relative z-20 h-full flex flex-col justify-between p-6 sm:p-10 md:p-12">
              
              <div className="max-w-xl space-y-3 sm:space-y-4">
                <h2 className="font-['Plus_Jakarta_Sans','Geist',sans-serif] font-bold text-3xl sm:text-4xl lg:text-5xl uppercase tracking-tighter text-white leading-[0.95] select-none">
                  CARE IS A PROCESS <br />
                  OF <span className="font-['Bricolage_Grotesque'] font-extrabold italic text-[#FF4B00] lowercase pr-3 tracking-normal inline-block transform -rotate-1">attention.</span>
                </h2>

                <p className="font-['Geist','Manrope',sans-serif] text-xs sm:text-sm text-[#D8D8D5] leading-relaxed max-w-md font-normal border-l-2 border-[#FF4B00] pl-4">
                  At TMR Car Care, we study the clear coat condition, choose the appropriate correction method, and finish with lasting surface protection.
                </p>

                <div className="pt-1">
                  <Link
                    to="/services/detailing-paint-care"
                    className="inline-flex items-center gap-2 font-['Geist','Manrope',sans-serif] font-bold text-xs uppercase tracking-[0.2em] text-[#FF4B00] hover:text-white transition-colors group"
                  >
                    <span>EXPLORE OUR PROCESS</span>
              ...
              {/* Minimal Integrated 3-Step Navigation Bar Inside Frame */}
              <div className="pt-4 border-t border-white/15 grid grid-cols-3 gap-4 text-xs font-['Geist','Manrope',sans-serif]">
                <div className="flex items-center gap-2">
                  <span className="text-[#FF4B00] font-bold font-mono">01</span>
                  <span className="text-white font-semibold uppercase tracking-wider text-[11px] sm:text-xs">OBSERVE</span>
                </div>
                <div className="flex items-center gap-2 border-l border-white/15 pl-4">
                  <span className="text-[#FF4B00] font-bold font-mono">02</span>
                  <span className="text-white font-semibold uppercase tracking-wider text-[11px] sm:text-xs">CARE</span>
                </div>
                <div className="flex items-center gap-2 border-l border-white/15 pl-4">
                  <span className="text-[#FF4B00] font-bold font-mono">03</span>
                  <span className="text-white font-semibold uppercase tracking-wider text-[11px] sm:text-xs">FINISH</span>
                </div>
              </div>
