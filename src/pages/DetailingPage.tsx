...
export const DetailingPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    metaDesc.setAttribute(
      'content',
      'Professional car detailing, machine paint correction, swirl mark removal, and paint restoration studio in Tiruppur at TMR AI Car Care.'
    );
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full py-4 text-left flex items-center justify-between gap-4 group/btn focus:outline-none focus:text-[#FF4B00] cursor-pointer min-h-[44px]"
                    >
                      <div className="flex items-center gap-4">
                        <span className="font-mono text-xs font-bold text-[#FF4B00]">
                          0{idx + 1}
                        </span>
                        <span className={`font-manrope font-extrabold text-base sm:text-lg uppercase transition-colors ${
                          isOpen ? 'text-[#FF4B00]' : 'text-[#0A0A0A] group-hover/btn:text-[#FF4B00]'
                        }`}>
                          {faq.q}
                        </span>
                      </div>
