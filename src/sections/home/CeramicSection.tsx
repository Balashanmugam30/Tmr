...
export const CeramicSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // 1. BOUNDARY TRANSITION: PROCESS RECEDES BEHIND, PROTECTION RISES SOLID IN FOREGROUND
      const boundaryTl = gsap.timeline({
        scrollTrigger: {
          trigger: sectionRef.current,
          start: 'top bottom', // Starts as Protection enters bottom of viewport over Process
      ...
      // Protection rises into foreground as a 100% SOLID OPAQUE sheet (opacity=1 ALWAYS)
      boundaryTl.fromTo(
      ...
      // 2. INTERNAL EDITORIAL ELEMENTS FADE/SLIDE ENTRANCE ONCE SETTLED IN VIEWPORT
  ...
  return (
    ...
    >
      {/* INNER WRAPPER PARTICIPATING IN BOUNDARY FOREGROUND SLIDE (ALWAYS OPACITY = 1 SOLID) */}
      <div
        ref={innerWrapperRef}
