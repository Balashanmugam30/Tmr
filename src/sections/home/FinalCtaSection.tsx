  ...
  return (
    ...
    >
      ...
      <Container className="relative z-20 max-w-[1380px] mx-auto w-full h-full flex flex-col justify-between py-12 md:py-16">
        ...
        <div className="cta-anim-item w-full pt-6 border-t border-white/15 flex items-center justify-between text-[10px] sm:text-[11px] font-extrabold uppercase tracking-[0.22em] text-white/60 relative z-20">
